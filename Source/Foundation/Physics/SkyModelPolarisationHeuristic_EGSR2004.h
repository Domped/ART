...
ART_MODULE_INTERFACE(SkyModelPolarisationHeuristic_EGSR2004)

#include "ART_Foundation_LightAndAttenuation.h"

/* ---------------------------------------------------------------------------
    'sky_polarisation_heuristic_egsr2004_init_polarised_l'
        Initializes the polarisation state of a given skylight radiance based
        on sun position and viewing angle.
--------------------------------------------------------------------------- */
