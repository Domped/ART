...
#ifndef _ART_FOUNDATION_LIGHTANDATTENUATION_ARATTENUATIONSAMPLE_GV_H_
#define _ART_FOUNDATION_LIGHTANDATTENUATION_ARATTENUATIONSAMPLE_GV_H_

#include "ArDirectAttenuationSample.h"

typedef struct ArDirectAttenuationSample_GV
{
    unsigned int  act_has_been_initialised;

    struct ArDirectAttenuationSample  * ardirectattenuationsample_total;
    struct ArDirectAttenuationSample  * ardirectattenuationsample_none;
    ...
    void (* _aaf_a_to_mm)
    ( const ART_GV *, const void *, ArMuellerMatrixSample * );
...
ArDirectAttenuationSample_GV;

#endif /* _ART_FOUNDATION_LIGHTANDATTENUATION_ARATTENUATIONSAMPLE_GV_H_ */
/* ======================================================================== */
