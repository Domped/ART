...
//#define DEBUG_arlightherosample_l_with_ref_to_sv
//#define DEBUG_arlightherosample_l_add_l
//#define DEBUG_arlightherosample_ll_add_l
//#define DEBUG_arlightherosample_ll_sub_l
...
#ifdef DEBUG_arlightherosample_l_with_ref_to_sv
#define ARLIGHTHEROSAMPLE_L_WITH_REF_TO_SC_DEBUGPRINTF \
do{ \
    printf("\n*****  arlightherosample_l_with_ref_to_sv  *****\n\n"); \
    printf("###  input arguments  ###\n"); \
    printf("const l_0:\n"); \
    arlightherosample_l_debugprintf( l_0 ); \
    printf("const r_0:\n"); \
    ...
    printf("\n###  output arguments  ###\n\n"); \
    printf("s_r:\n"); \
    arstokesvectorherosample_sc_debugprintf( s_r ); \
    fflush(stdout); \
} while (0)
#else
#define ARLIGHTHEROSAMPLE_L_WITH_REF_TO_SC_DEBUGPRINTF
...
#ifdef DEBUG_arlightherosample_l_add_l
#define ARLIGHTHEROSAMPLE_L_ADD_L_DEBUGPRINTF_A \
do{ \
    printf("\n*****  arlightherosample_ll_add_l  *****\n\n"); \
    printf("###  input arguments  ###\n"); \
    printf("const l_0:\n"); \
    arlightherosample_l_debugprintf( l_0 ); \
    printf("l_r:\n"); \
    arlightherosample_l_debugprintf( l_r ); \
} while (0)
#define ARLIGHTHEROSAMPLE_L_ADD_L_DEBUGPRINTF_B \
do{ \
    printf("\n###  output arguments  ###\n\n"); \
    printf("l_r:\n"); \
    arlightherosample_l_debugprintf( l_r ); \
...
#ifdef DEBUG_arlightherosample_ll_add_l
#define ARLIGHTHEROSAMPLE_LL_ADD_L_DEBUGPRINTF \
do{ \
    printf("\n*****  arlightherosample_ll_add_l  *****\n\n"); \
    printf("###  input arguments  ###\n"); \
    printf("const l_0:\n"); \
    arlightherosample_l_debugprintf( l_0 ); \
    printf("const l_1:\n"); \
    arlightherosample_l_debugprintf( l_1 ); \
    printf("\n###  output arguments  ###\n\n"); \
    printf("l_r:\n"); \
    arlightherosample_l_debugprintf( l_r ); \
    fflush(stdout); \
...
#ifdef DEBUG_arlightherosample_ll_sub_l
#define ARLIGHTHEROSAMPLE_LL_SUB_L_DEBUGPRINTF \
do{ \
    printf("\n*****  arlightherosample_ll_sub_l  *****\n\n"); \
    printf("###  input arguments  ###\n"); \
    printf("const l_0:\n"); \
    arlightherosample_l_debugprintf( l_0 ); \
    printf("const l_1:\n"); \
