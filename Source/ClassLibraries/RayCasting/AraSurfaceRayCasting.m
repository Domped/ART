...
#define ART_MODULE_NAME     AraSurfaceRayCasting
...
#define SURFACE    ( (ArNode <ArpSurfaceMaterial> *) ARNODEREF_POINTER(attributeRef) )

@implementation AraSurfaceMaterial ( RayCasting )

ARPRAYCASTING_DEFAULT_IMPLEMENTATION(AraSurfaceMaterial)

- (ArNode <ArpVolumeMaterial> *) volumeMaterial_at_WorldPnt3D
        : (ArnRayCaster *) rayCaster
{
    ArNodeRef  surfaceStore;

    [ rayCaster pushSurfaceMaterialRef
        :   WEAK_NODE_REFERENCE( SURFACE )
        : & surfaceStore
        ];
