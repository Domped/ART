...
ART_MODULE_INTERFACE(ArnAdaptiveSampler2D)

#import "ART_Scenegraph.h"

@interface ArnAdaptiveSampler2D
        : ArnUnary
        < ArpConcreteClass, ArpCoding, ArpSampling2D >
{
    double        lengthMaxError;
    unsigned int  lengthMaxRecursionDepth;
    double        areaMaxError;
