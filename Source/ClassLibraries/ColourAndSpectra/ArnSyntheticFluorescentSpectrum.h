...
ART_MODULE_INTERFACE(ArnSyntheticFluorescentSpectrum)

#import "ART_Scenegraph.h"

#import "ArnConstSpectrum.h"

@interface ArnSyntheticFluorescentSpectrum
        : ArnUnary < ArpConcreteClass, ArpSpectrum2D, ArpSpectrumValues >
{
    double           crosstalkMaximum;
    Pnt2D            crosstalkCenter;
    Vec2D            crosstalkExtent;
    
    ArSpectrum     * mainDiagonalColour;
