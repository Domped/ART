...
ART_MODULE_INTERFACE(ArnFresnelEmissiveSurfaceMaterial)
...
@interface ArnFresnelEmissiveSurfaceMaterial
    : ArnFresnelSurfaceMaterial
{
    double           temperature;
    double           relativeScale;
    ArLight        * blackbodyEmission;
    ArAttenuation  * absorbanceAtEmissionPoint;
