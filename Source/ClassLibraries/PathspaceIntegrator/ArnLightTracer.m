...
//
//            }
            arlightsample_d_mul_l(art_gv, currentState->throughput * hashgrid->vmNormalization, vmContribution->light);
...
//
    ...
    arlightsample_free(art_gv, lightSample);
