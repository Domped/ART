...
#define ART_MODULE_NAME     ArpLightsourceSampling_Categories

#import "ArpLightsourceSampling_Categories.h"

ART_MODULE_INITIALISATION_FUNCTION
(
    ART_PERFORM_MODULE_INIT_FROM_MODULE(ArcAmbientLightsourceSampling)
    ART_PERFORM_MODULE_INIT_FROM_MODULE(ArcAreaLightsourceSampling)
...
(
    ART_PERFORM_MODULE_SHUTDOWN(ArcAmbientLightsourceSampling)
    ART_PERFORM_MODULE_SHUTDOWN(ArcAreaLightsourceSampling)
