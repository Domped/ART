...
ART_MODULE_INTERFACE(ArpLightsourceSampling_Categories)

#import "ART_Protocols.h"
#import "ART_Lightsource.h"

@interface ArcAmbientLightsource ( RaySampling )
    < ArpLightsourceSampling >
@end

@interface ArcAreaLightsource ( RaySampling )
< ArpLightsourceSampling >
@end

@interface ArcInfiniteSphereLightsource ( RaySampling )
< ArpLightsourceSampling >
@end

@interface ArcPointLightsource ( RaySampling )
< ArpLightsourceSampling >
@end
...
ART_MODULE_INTERFACE(ArcAmbientLightsourceSampling)
ART_MODULE_INTERFACE(ArcAreaLightsourceSampling)
