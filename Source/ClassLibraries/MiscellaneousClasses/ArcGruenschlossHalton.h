...
ART_MODULE_INTERFACE(ArcGruenschlossHalton)
...
/* ---------------------------------------------------------------------------
    ...
    ArcGruenschlossHalton class
    ---------------------------

    An ART wrapper around Leo Gruenschloss' Halton sequence implementation.
...
@interface ArcGruenschlossHalton
