...
#define ART_MODULE_NAME     ArNode_ARM_CSG_Operators
...
@implementation ArNode ( ARM_CSG_Operators )
...
*/
    return
        [ ALLOC_INIT_OBJECT_AUTORELEASE(ArnCSGor)
...
*/
    return
        [ ALLOC_INIT_OBJECT_AUTORELEASE(ArnCSGand)
            :   HARD_NODE_REFERENCE(self)
            :   HARD_NODE_REFERENCE(node)
            ];
}
...
*/
    return
        [ ALLOC_INIT_OBJECT_AUTORELEASE(ArnCSGsub)
            :   HARD_NODE_REFERENCE(self)
            :   HARD_NODE_REFERENCE(node)
            ];
}
