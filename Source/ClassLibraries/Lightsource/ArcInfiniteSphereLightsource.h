...
ART_MODULE_INTERFACE(ArcInfiniteSphereLightsource)

#import "ArcLightsource.h"

@class ArnLightsourceCollector;

@interface ArcInfiniteSphereLightsource
        : ArcLightsource
{
    ArNode <ArpEnvironmentMaterial> * environmentMaterial;

    ArLight        * infSphereRadiance;
    double           infSphereRadianceNorm;
    double           infSphereArea;
