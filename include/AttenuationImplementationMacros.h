...
#ifndef _ART_FOUNDATION_LIGHTANDATTENUATION_ATTENUATIONIMPLEMENTATIONMACROS_H_
#define _ART_FOUNDATION_LIGHTANDATTENUATION_ATTENUATIONIMPLEMENTATIONMACROS_H_

#define SWITCHING_IMPLEMENTATION_FOR_ACT( _type ) \
\
...
\
    art_gv->ardirectattenuation_gv->_aaf_d_alloc_init = \
        ...
        _type##_d_alloc_init;\
\
    art_gv->ardirectattenuation_gv->_aaf_drr_alloc_init_depolarising = \
        ( void * (*) \
        ( const ART_GV *, const double, \
          const ArReferenceFrame  *, const ArReferenceFrame  * )) \
        _type##_drr_alloc_init_depolarising;\
\
    art_gv->ardirectattenuation_gv->_aaf_drr_alloc_init_nonpolarising = \
        ( void * (*) \
        ( const ART_GV *, const double, \
          const ArReferenceFrame  *, const ArReferenceFrame  * )) \
...
\
    art_gv->ardirectattenuation_gv->_aaf_total = \
        ...
        _type##_total;\
\
    art_gv->ardirectattenuation_gv->_aaf_rr_alloc_init_total = \
        ( void * (*) \
...
\
    art_gv->ardirectattenuation_gv->_aaf_none = \
        ...
        _type##_none;\
\
    art_gv->ardirectattenuation_gv->_aaf_rr_alloc_init_none = \
        ( void * (*) \
        ( const ART_GV *, const ArReferenceFrame  *, \
          const ArReferenceFrame  * )) \
...
\
    art_gv->ardirectattenuation_gv->_aaf_a_to_mm = \
        (void (*) ( const ART_GV *, const void *, ArMuellerMatrix * )) \
        _type##_a_to_mm;\
\
...
\
    art_gv->ardirectattenuation_gv->act_has_been_initialised = 1; \
}

#endif /* _ART_FOUNDATION_LIGHTANDATTENUATION_ATTENUATIONIMPLEMENTATIONMACROS_H_ */
/* ======================================================================== */
